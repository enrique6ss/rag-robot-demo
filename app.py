...
# Local Llama-3
llm = LlamaCPP(
    model_url="https://huggingface.co/bartowski/Meta-Llama-3.1-8B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-8B-Instruct-Q3_K_M.gguf",
    temperature=0.1,
    max_new_tokens=512,
    context_window=2048,  # Reduced to fit memory
